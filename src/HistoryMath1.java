...
public class HistoryMath1 {
    ...
    public static void decimal2(String[] args) throws IOException {
    ...
    public static void get_prime() {
        ...
        for (int i = 2; i <= Math.sqrt(prime.length); i++) {
            if (prime[i]) continue;//이미 체크 된 배열일 경우 생략
    ...
    public static void primeFactorization(String[] args) throws IOException {
